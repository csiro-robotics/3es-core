...
template <typename T>
Matrix4<T>::Matrix4(const T &rc00, const T &rc01, const T &rc02, const T &rc03, const T &rc10, const T &rc11,
...
template <typename T>
Matrix4<T> Matrix4<T>::lookAt(const Vector3<T> &eye, const Vector3<T> &target, const Vector3<T> &axisUp,
...
{
  const Matrix4<T> m(rc[0][0], rc[1][0], rc[2][0], rc[3][0], rc[0][1], rc[1][1], rc[2][1], rc[3][1], rc[0][2], rc[1][2],
                     rc[2][2], rc[3][2], rc[0][3], rc[1][3], rc[2][3], rc[3][3]);
  return m;
}
