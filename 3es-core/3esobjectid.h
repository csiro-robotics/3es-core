...
public:
  ...
  {}
  /// @overload
  explicit ObjectID(char id)
    : _id(uint32_t(id))
  {}
  /// @overload
  explicit ObjectID(unsigned char id)
    : _id(uint32_t(id))
  {}
  /// @overload
  explicit ObjectID(short id)
    : _id(uint32_t(id))
  {}
  /// @overload
  explicit ObjectID(unsigned short id)
    : _id(uint32_t(id))
  {}
  ...
  {}
  /// @overload
  explicit ObjectID(unsigned id)
    : _id(id)
  {}
  /// @overload
  explicit ObjectID(long long id)
    : _id(uint32_t(id))
  {}
  /// @overload
  explicit ObjectID(unsigned long long id)
    : _id(uint32_t(id))
  {}
  /// @overload
  explicit ObjectID(const void *ptr)
    : _id(uint32_t(reinterpret_cast<size_t>(ptr)))
  {}
