...
public:
  ...
  static unsigned writeIndices(PacketWriter &packet, uint32_t meshId, uint32_t offset, unsigned byteLimit,
  ...
  /// @param componentCount The total number of indices.
  /// @return The number of indices written.
  static unsigned writeVectors3(PacketWriter &packet, uint32_t meshId, uint32_t offset, unsigned byteLimit,
  ...
  /// @param componentCount The total number of indices.
  /// @return The number of indices written.
  static unsigned writeVectors2(PacketWriter &packet, uint32_t meshId, uint32_t offset, unsigned byteLimit,
                                const uint8_t *dataSource, unsigned dataStride, uint32_t componentCount);
  ...
  /// @param componentCount The total number of indices.
  /// @return The number of indices written.
  static unsigned writeColours(PacketWriter &packet, uint32_t meshId, uint32_t offset, unsigned byteLimit,
                               const uint8_t *dataSource, unsigned dataStride, uint32_t componentCount);
