...
public:
  ...
  PointCloudShape(const MeshResource *mesh = nullptr, const IdCat &id = IdCat(), float pointScale = 0.0f);
...
inline PointCloudShape::PointCloudShape(const MeshResource *mesh, const IdCat &id, float pointScale)
