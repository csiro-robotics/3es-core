...
template Matrix4<float> _3es_coreAPI quaternionTranslationToTransform(const Quaternion<float> &quaternion,
                                                                      const Vector3<float> &translation);
template Matrix4<double> _3es_coreAPI quaternionTranslationToTransform(const Quaternion<double> &quaternion,
...
template Matrix4<float> _3es_coreAPI prsTransform(const Vector3<float> &translation,
                                                  const Quaternion<float> &quaternion, const Vector3<float> &scale);
template Matrix4<double> _3es_coreAPI prsTransform(const Vector3<double> &translation,
...
template void _3es_coreAPI transformToQuaternionTranslation(const Matrix4<float> &m, Quaternion<float> &q,
                                                            Vector3<float> &translation, Vector3<float> *scale);
template void _3es_coreAPI transformToQuaternionTranslation(const Matrix4<double> &m, Quaternion<double> &q,
...
template Quaternion<float> _3es_coreAPI transformToQuaternionTranslation(const Matrix4<float> &m,
                                                                         Vector3<float> &translation);
template Quaternion<double> _3es_coreAPI transformToQuaternionTranslation(const Matrix4<double> &m,
