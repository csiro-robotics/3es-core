...
#pragma GCC diagnostic pop
  ...
  inline Vector4(const Vector3<T> &other, const T &w)
    : x(other.x)
    , y(other.y)
    , z(other.z)
    , w(w)
  ...
  /// @param other Vector to copy the value of.
  template <typename Q>
  explicit inline Vector4(const Vector4<Q> &other)
    : x(other.x)
    , y(other.y)
    , z(other.z)
    , w(other.w)
  ...
  /// @param w The w component value.
  template <typename Q>
  explicit inline Vector4(const Vector3<Q> &other, const T &w)
    : x(other.x)
    , y(other.y)
    , z(other.z)
    , w(w)
  ...
  /// @return This.
  template <typename Q>
  inline Vector4<T> &operator=(const Vector4<Q> &other)
  {
    x = T(other.x);
    y = T(other.y);
    z = T(other.z);
...
template <typename T>
const T Vector4<T>::Epsilon = T(1e-6);
template <typename T>
const Vector4<T> Vector4<T>::zero(T(0));
template <typename T>
const Vector4<T> Vector4<T>::one(T(1));
template <typename T>
