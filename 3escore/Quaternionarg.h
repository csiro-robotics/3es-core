...
struct QuaternionArg
{
  ...
  inline QuaternionArg(const float q[4])
    : q(q)
  {}
  /// Double precision pointer constructor.
  /// @param q Quaternion array.
  inline QuaternionArg(const double q[4])
    : q(Quaterniond(q))
  {}
  /// Single precision quaternion constructor.
  /// @param q Quaternion value.
  inline QuaternionArg(const Quaternionf &q)
    : q(q)
  {}
  /// Double precision quaternion constructor.
  /// @param q Quaternion value.
  inline QuaternionArg(const Quaterniond &q)
    : q(q)
  {}
  ...
  /// @param z Z value.
  /// @param w W value.
  inline QuaternionArg(float x, float y, float z, float w)
    : q(x, y, z, w)
  {}
