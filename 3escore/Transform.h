...
public:
  ...
  bool isEqual(const Transform &other, const double epsilon = Vector3d::kEpsilon) const;
...
public:
  ...
  /// @param preferDouble Optional override for precision selection.
  inline Directional(const Vector3f &pos, const Vector3f dir = Vector3f(DefaultDirection),
                     float radius = 1.0f, float length = 1.0f, bool preferDouble = false)
  ...
  /// @param length The length scaling, mapped to Z of @c scale .
  /// @param preferDouble Optional override for precision selection.
  inline Directional(const Vector3d &pos, const Vector3d dir = DefaultDirection,
                     double radius = 1.0, double length = 1.0, bool preferDouble = true)
  ...
  /// @param length The length scaling, mapped to Z of @c scale .
  /// @param preferDouble Optional override for precision selection.
  inline Directional(const Vector3f &pos, float radius, float length = 1.0f,
  ...
  /// @param length The length scaling, mapped to Z of @c scale .
  /// @param preferDouble Optional override for precision selection.
  inline Directional(const Vector3d &pos, double radius, double length = 1.0,
                     bool preferDouble = false)
