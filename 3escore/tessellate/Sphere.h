...
/// @param hemisphereRingCount Number of rings latitudal rings in each hemisphere. Excludes the
/// equatorial ring.
/// @param segments Number of longitudal segments.
/// @param axis Primary axis for the sphere, which determines the polar regions.
/// @param hemisphereOnly True to tesselate a hemisphere only. The hemisphere is built in the
...
void TES_CORE_API solidLatLong(std::vector<Vector3f> &vertices, std::vector<unsigned> &indices,
                               ...
                               unsigned hemisphereRingCount = 5, unsigned segments = 32,
