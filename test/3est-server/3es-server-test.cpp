                  ...
                  std::vector<Resource *> &resources, int argc, const char **argv)
{
  ...
  if (allShapes || haveOption("lines", argc, argv))
  {
    ...
    MeshShape *lines = new MeshShape(DtLines, ShapeId(nextId++, CatLines), VertexStream(lineSet, lineVertexCount));
  ...
  if (allShapes || haveOption("triangles", argc, argv))
  {
    ...
    MeshShape *triangles =
      new MeshShape(DtTriangles, ShapeId(nextId++, CatTriangles), VertexStream(triangleSet, triVertexCount));
  ...
  if (allShapes || haveOption("points", argc, argv))
  {
    ...
    MeshShape *points = new MeshShape(DtPoints, ShapeId(nextId++, CatPoints), VertexStream(pts, pointsCount));
