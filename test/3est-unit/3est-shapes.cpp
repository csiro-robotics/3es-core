...
TEST(Shapes, Arrow)
{
  ...
  testShape(Arrow(IdCat(42u, 1), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 2.0f, 0.05f)));
}
...
TEST(Shapes, Box)
{
  ...
  testShape(Box(IdCat(42u, 1), Transform(Vector3f(1.2f, 2.3f, 3.4f),
...
TEST(Shapes, Capsule)
{
  ...
  testShape(
    Capsule(IdCat(42u, 1), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 0.3f, 2.05f)));
}

TEST(Shapes, Cone)
{
  testShape(Cone(IdCat(42u), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 0.35f, 3.0f)));
  testShape(Cone(IdCat(42u, 1), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 0.35f, 3.0f)));
}

TEST(Shapes, Cylinder)
{
  testShape(
    Cylinder(IdCat(42u), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 0.25f, 1.05f)));
  testShape(
    Cylinder(IdCat(42u, 1), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 0.25f, 1.05f)));
}
...
TEST(Shapes, MeshSet)
{
  ...
  {
    MeshSet set(IdCat(42u, 1), meshes.size());
...
TEST(Shapes, Mesh)
{
  ...
  testShape(
    MeshShape(DtPoints, vertices.data()->v, unsigned(vertices.size()), sizeof(*vertices.data()),
  ...
  testShape(
    MeshShape(DtTriangles, vertices.data()->v, unsigned(vertices.size()), sizeof(*vertices.data()), indices.data(),
              unsigned(indices.size()),
              Transform(Vector3f(1.2f, 2.3f, 3.4f), Quaternionf().setAxisAngle(Vector3f(1, 1, 1), degToRad(18.0f)),
                        Vector3f(1.0f, 1.2f, 0.8f))));
  // 3. drawType, verts, vcount, vstrideBytes, id, pos, rot, scale
  testShape(
    MeshShape(DtPoints, vertices.data()->v, unsigned(vertices.size()), sizeof(*vertices.data()), IdCat(42u),
              Transform(Vector3f(1.2f, 2.3f, 3.4f), Quaternionf().setAxisAngle(Vector3f(1, 1, 1), degToRad(18.0f)),
                        Vector3f(1.0f, 1.2f, 0.8f))));
  ...
  testShape(
    MeshShape(DtTriangles, vertices.data()->v, unsigned(vertices.size()), sizeof(*vertices.data()), indices.data(),
              unsigned(indices.size()), IdCat(42u),
              Transform(Vector3f(1.2f, 2.3f, 3.4f), Quaternionf().setAxisAngle(Vector3f(1, 1, 1), degToRad(18.0f)),
                        Vector3f(1.0f, 1.2f, 0.8f))));
  ...
  testShape(
    MeshShape(DtTriangles, vertices.data()->v, unsigned(vertices.size()), sizeof(*vertices.data()), indices.data(),
              unsigned(indices.size()), IdCat(42u, 1),
              Transform(Vector3f(1.2f, 2.3f, 3.4f), Quaternionf().setAxisAngle(Vector3f(1, 1, 1), degToRad(18.0f)),
                        Vector3f(1.0f, 1.2f, 0.8f))));

  // II> Test with uniform normal.
  testShape(
    MeshShape(DtVoxels, vertices.data()->v, unsigned(vertices.size()), sizeof(*vertices.data()), IdCat(42u),
              Transform(Vector3f(1.2f, 2.3f, 3.4f), Quaternionf().setAxisAngle(Vector3f(1, 1, 1), degToRad(18.0f)),
                        Vector3f(1.0f, 1.2f, 0.8f)))
...
TEST(Shapes, Plane)
{
  testShape(Plane(IdCat(42u), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 5.0f, 0.75f)));
  testShape(Plane(IdCat(42u, 1), Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 1, 1).normalised(), 5.0f, 0.75f)));
}
...
TEST(Shapes, PointCloud)
{
  ...
  // Full res cloud.
  testShape(PointCloudShape(&cloud, IdCat(42u), 8));
  ...
  testShape(PointCloudShape(&cloud, IdCat(42u, 1), 8).setIndices(indices.data(), unsigned(indices.size())));
}

TEST(Shapes, Pose)
{
  testShape(Pose(IdCat(42u),
                 Transform(Vector3f(1.2f, 2.3f, 3.4f), Quaternionf().setAxisAngle(Vector3f::axisz, float(0.25 * M_PI)),
                           Vector3f(0.25f, 0.5f, 1.5f))));
  testShape(Pose(IdCat(42u, 1),
                 Transform(Vector3f(1.2f, 2.3f, 3.4f), Quaternionf().setAxisAngle(Vector3f::axisz, float(0.25 * M_PI)),
                           Vector3f(0.25f, 0.5f, 1.5f))));
}
...
TEST(Shapes, Sphere)
{
  testShape(Sphere(IdCat(42u), Spherical(Vector3f(1.2f, 2.3f, 3.4f), 1.26f)));
  testShape(Sphere(IdCat(42u, 1), Spherical(Vector3f(1.2f, 2.3f, 3.4f), 1.26f)));
}

TEST(Shapes, Star)
{
  testShape(Star(IdCat(42u), Spherical(Vector3f(1.2f, 2.3f, 3.4f), 1.26f)));
  testShape(Star(IdCat(42u, 1), Spherical(Vector3f(1.2f, 2.3f, 3.4f), 1.26f)));
}

TEST(Shapes, Text2D)
{
  testShape(Text2D("Transient Text2D", IdCat(), Spherical(Vector3f(1.2f, 2.3f, 3.4f))));
  testShape(Text2D("Persistent Text2D", 42u, Spherical(Vector3f(1.2f, 2.3f, 3.4f))));
  testShape(Text2D("Persistent, categorised Text2D", IdCat(42u, 1), Spherical(Vector3f(1.2f, 2.3f, 3.4f))));
}

TEST(Shapes, Text3D)
{
  // Validate all the constructors.
  testShape(Text3D("Transient Text3D", IdCat(), Directional(Vector3f(1.2f, 2.3f, 3.4f), 14)));
  testShape(Text3D("Transient oriented Text3D", IdCat(),
                   Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 2, 3).normalised(), 8)));
  testShape(Text3D("Persistent Text3D", IdCat(42u), Directional(Vector3f(1.2f, 2.3f, 3.4f), 23)));
  testShape(Text3D("Persistent oriented Text3D", IdCat(42u),
                   Directional(Vector3f(1.2f, 2.3f, 3.4f), Vector3f(1, 2, 3).normalised(), 12)));
  testShape(Text3D("Persistent, categorised, oriented Text3D", IdCat(42u, 1),
...
TEST(Shapes, FileStream)
{
  ...
  Sphere shape(IdCat(42u), Spherical(Vector3f(1.2f, 2.3f, 3.4f), 1.26f));
